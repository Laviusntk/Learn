...
public abstract class Client {
    ...
    public AuthStatus authenticate(String _path) throws Exception {
        generateCrentials();
        ...
        if (code != 200 && code != 201) {
            return new AuthStatus(code,"Failed to create session");
        } else {
            return new AuthStatus(code,this.SESSION);
        }
    }
